...
int main(){
    ...
    ofstream writeFile;
    writeFile.open("notes.txt",ios::out);  // Open the file in write mode
    ...
    cout<<"Reading and displaying file contents"<<endl;
    ...
    cout<<"Appending name and roll number"<<endl;
    ofstream appendFile;
    ...
    cout<<"Reading and displaying updated file contents\n"<<endl;
    ...
    if (readUpdatedFile.is_open()){
        ...
        cout<<"Updated file read successfully!"<<endl;
    } else {
